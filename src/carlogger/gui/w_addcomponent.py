...
class AddComponentPopup:
    def __init__(self, master, root, parent_collection, parent_car):
        self.master = master
        self.root = root
    ...
    def add_component(self):
        ...
        if not self._has_all_necessary_fields(comp_data):
    ...
    def _post_entry_add(self):
        self.close_menu()
        self.root.go_to_collection(self.parent_collection)
...
class PropertyContainer(CTkFrame):
    def __init__(self, master, root: CTk, parent: AddComponentPopup, **values):
