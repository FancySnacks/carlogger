...
class ComponentContainer(CTkFrame):
    ...
    def add_item(self, item_ref: ITEM):
        ...
        new_item = ComponentItem(self, item_ref, column, row=row)
    ...
    def go_to_component(self, item_ref: ITEM):
