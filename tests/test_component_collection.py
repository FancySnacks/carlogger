...
def test_get_function_returns_only_car_parts(mock_component_collection):
    parts = mock_component_collection.get_all_components(mock_component_collection.car_components)
...
def test_get_function_returns_entry_logs(mock_log_entry, mock_component_collection):
    ...
    mock_component_collection.car_components.append(c)

    logs = mock_component_collection.get_all_log_entries(mock_component_collection.car_components)
